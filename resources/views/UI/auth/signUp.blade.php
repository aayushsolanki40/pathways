                ...
                <div class="col-12 ranking-listing">
                    <div class="row text-center justify-content-center">
                        <div class="col-lg-8 col-md-8 col-sm-10 system-column">
                            <form action="{{route('ui.auth.makeSignup')}}" method="post">
                                @csrf
                                <div class="security-form">
                                    <div class="security-form-sub signup-form">
                                        ...
                                        <div class="form-group"><input type="text" name="email" class="form-control"
                                                placeholder="Email" value="" autocomplete=false></div>
                                        <div class="form-group"><input type="text" name="phone" class="form-control"
                                                placeholder="Phone" value="" autocomplete=false></div>
                                        <div class="form-group"><input type="password" name="password" class="form-control"
                                                placeholder="Password" value="" autocomplete=false></div>
                                        <div class="form-group"><input type="password" name="confPassword" class="form-control"
                                                placeholder="Confirm Password" value="" autocomplete=false></div>
                                    </div>
